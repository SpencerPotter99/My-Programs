...
class ResearchFragment : Fragment() {
    override fun onCreateView(
        ...
        binding.goToHomeFromResearch.setOnClickListener{
            findNavController().navigate(R.id.action_researchFragment_to_homeFragment2)
        }
        val research1 = Research("Artificial Intelligence", "Multi-agent systems, " +
                "physics informed deep learning, criticality in natural systems, automatic " +
                "differentiation, deep neural networks, AI for social impact, robotics, " +
                "decision science, precision apiculture, precision agriculture, assistive technology," +
                " PIV/PTV, and computability.","Faculty: Vicki Allan, Nick Flann, " +
                "Hamid Karimi, Mario Harper, and Vladimir Kulyukin" )
        ...
        val reseraches = mutableListOf<Research>(research1,research2,research3,research4,research5,research6,research7,research8,research9,research10,research11,research12)

        binding.researchRecycler.adapter = ResearchAdapter(reseraches)
